...
public class LimitsCalculatorBenchmark {
    @State(Scope.Benchmark)
    public static class LimitsCalculatorBenchmarkState {
        public LimitsCalculator theLimitsCalculator;
        public final List<PnL> thePnLs = new ArrayList<>();

        private static final int LOOP_COUNT = 100;
        public LimitsCalculatorBenchmarkState() {
    ...
    public void limitsCalculatorBenchmark(LimitsCalculatorBenchmarkState aBenchmarkState) {
